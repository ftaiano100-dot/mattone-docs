...
<Note>
  ...
  - **KrossBooking** → `/integrazioni/kross/troubleshooting`
  - **SwitchBot / Smart lock** → `/integrazioni/switchbot/troubleshooting`
  - **Stripe / Pagamenti** → `/integrazioni/stripe/troubleshooting`
  - **Conduit / Agente AI** → `/integrazioni/conduit/troubleshooting`
</Note>
