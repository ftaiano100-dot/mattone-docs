...
<Steps>
  <Step title="Contratti & amministrazione">Contratto firmato, dati di fatturazione e aspetti amministrativi a posto. Per chi attiva **Conduit**: è **obbligatorio** l'**Addendum "Servizio AI Ospiti"** (Mattone.co LLC ↔ studente) firmato **prima** dell'attivazione — regola canone €9/Listing/mese, Costi a Consumo, durata minima 12 mesi e addebito. Vedi [Step 3 · Conduit](/onboarding/3-conduit).</Step>
