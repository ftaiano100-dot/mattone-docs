...
<Info>
  **Cosa dire allo studente — chiave Stripe**
  ...
  🎥 Video tutorial ufficiale (Cosmica Group) — *"Guida alla configurazione delle chiavi API Stripe su piattaforma Mattone"*: [kommodo.ai/recordings/IQC7ADofCfiURbkPqxyF](https://kommodo.ai/recordings/IQC7ADofCfiURbkPqxyF). Puoi girarlo direttamente allo studente.
</Info>
