...
<Note>
  Per i casi operativi dettagliati su late check-in/out e upsell, vedi le [Casistiche](/casistiche/late-early-checkin). Per domande sullo schema tecnico dei workflow, apri un ticket al supporto Conduit.
</Note>
