...
| **Il salvataggio di un articolo KB fallisce silenziosamente** | Bug noto su operazione UPDATE in Conduit | Non aggiornare l'articolo esistente. Apri un ticket Conduit (riferimento: **Raniel**) e nel frattempo crea un **nuovo articolo** con il contenuto aggiornato, poi archivia il vecchio. |
...
<Accordion title="Bug UPDATE Knowledge Base (save silenzioso)">
  **Riferimento interno:** ticket Raniel (supporto Conduit)
  ...
  **Workaround:** non aggiornare articoli esistenti. Crea sempre un nuovo articolo con il contenuto aggiornato e archivia o elimina il vecchio. Segnala ogni occorrenza a Raniel con workspace ID e nome dell'articolo per tracciare il bug.
</Accordion>
