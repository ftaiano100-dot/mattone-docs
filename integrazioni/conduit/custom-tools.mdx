...
I custom tool sono provisionati esclusivamente dal team Mattone durante l'onboarding o su richiesta successiva. Lo studente non ha accesso alla configurazione dei tool. La fonte di verità per il catalogo completo e le configurazioni è il file `catalog.json` nel repository `api-kross-mattone/conduit-custom-tool/`.
