---
title: "Notion — Anagrafica canonica & upgrade"
...
<Warning>Non lanciare in prod studenti finché il **save bug** Conduit non è risolto: le CREATE funzionano, gli UPDATE flappano. Il bridge è già best-effort con create/skip.</Warning>
